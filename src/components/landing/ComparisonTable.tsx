...
const differentiators = [
  ...
  { emoji: "🛠\ufe0f", title: "Gebaut f\u00fcr Handwerker, nicht gegen sie", desc: "HufiAi macht dich besser bei dem, was du liebst \u2013 nicht versucht, dich zu ersetzen." },
    ...
    <section className="max-w-5xl mx-auto py-20 px-6">
      <div className="text-center mb-12">
        <h2 className="text-3xl md:text-4xl font-bold mb-3">
          Warum HufiAi anders ist
        </h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Ich baue HufiAi nicht als Tech-Gr\u00fcnder, der zuf\u00e4llig Pferde googelt. Ich baue HufiAi als Hufpfleger, der KI revolutioniert hat.
        </p>
      </div>
